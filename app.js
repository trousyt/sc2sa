...
app.get('/channel/:name', (req, res) => {
  ...
  work.getPlaylistFromSoundcloud(channel.playlistId)
    .then(playlist => work.transformPlaylist(transformer, playlist))
    .then(work.writeChannelXml)
    .then(work.cacheChannelXml)
    .catch(error => {
